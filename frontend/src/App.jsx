...
function App() {
  ...
  // ငွေကြေးအမျိုးအစား ရွေးချယ်ရန် State
      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <p style={{ textAlign: "center", marginTop: "20px", fontSize: "0.85rem", color: "#64748b" }}>
            ...
            <span 
              onClick={() => { setIsRegisterMode(!isRegisterMode); setConfirmPassword(""); setAuthError(""); }} 
  ...
  // User Login ဝင်ပြီးသားဆိုရင် ပြသမည့် UI (Dashboard + မူရင်း အသုံးစရိတ်ဇယားများ)
  return (
